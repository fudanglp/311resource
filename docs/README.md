...
- `analysis/stage_water_rendering_idb.md`：从 IDB 追踪 `water.wft`、水面 vertex/index buffer、渲染 pass，以及当前未闭环的水面 LINK entry 绑定。
...
| stage water rendering | `supporting evidence` | `analysis/stage_water_rendering_idb.md` |
